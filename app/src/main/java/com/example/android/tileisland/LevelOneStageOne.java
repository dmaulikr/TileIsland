...
public class LevelOneStageOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waves = MediaPlayer.create(LevelOneStageOne.this, R.raw.coinpickup);
    }
            ...
            actionThreeAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if ((int) imageXPosition == 1340) {
                        ...
                        activityTracker.updateActivity("LevelOneStageOne", String.valueOf(score));
                        // Dailouge for playing again the same level or next level
                        AlertDialog.Builder alertadd = new AlertDialog.Builder(LevelOneStageOne.this);
                        LayoutInflater factory = LayoutInflater.from(LevelOneStageOne.this);
                        ...
                        alertadd.setPositiveButton("Play Again!", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dlg, int something) {
                                Intent intent = new Intent(LevelOneStageOne.this, LevelOneStageOne.class);
                                startActivity(intent);
                            }
                        });
                        alertadd.setNegativeButton("Next Level >>", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dlg, int something) {
                                Intent intent = new Intent(LevelOneStageOne.this, LevelOneStageTwo.class);
                                startActivity(intent);
                            }
                        });
                        AlertDialog alert = alertadd.create();
                        alert.show();
                        waves = MediaPlayer.create(LevelOneStageOne.this, R.raw.gameover);
                        waves.start();
