...
public class LevelTwoStageOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waves = MediaPlayer.create(LevelTwoStageOne.this, R.raw.coinpickup);
    }
            ...
            actionThreeAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if ((int) imageXPosition == 1340) {
                        ...
                        activityTracker.updateActivity("LevelTwoStageOne", String.valueOf(score));
                        ...
                        alertadd.setNegativeButton("Next Level >>", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dlg, int something) {
                                Intent intent = new Intent(LevelTwoStageOne.this, LevelTwoStageTwo.class);
                                startActivity(intent);
                            }
                        });
                        AlertDialog alert = alertadd.create();
                        alert.show();
                        waves = MediaPlayer.create(LevelTwoStageOne.this, R.raw.gameover);
                        waves.start();
